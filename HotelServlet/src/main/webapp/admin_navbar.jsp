...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					<a class="nav-link active" href="main?action=default"><fmt:message
							key="nav.home" /></a> <a class="nav-link active" href="main?action=getAllUsers">
							<fmt:message
							key="nav.getAllUsers" /></a> <a class="nav-link"
						href="main?action=getAllRooms"><fmt:message
		...
		<div class="d-flex">
			<div class="navbar-nav">
				<a class="nav-link"
					href="main?action=changeLocale&language=ua&country=UK">UA</a> <a
					class="nav-link"
